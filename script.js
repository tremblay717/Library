  ...
  function createBookLinesLibrary(library) {
      ...
      for (let i = 0; i < library.length; i++) {
          ...
          editReading.setAttribute('style',
              'display:grid; align-items:center;justify-content:center;border-right-style:solid;border-right-width:1px');
          ...
          // h4 element for removing book
          const removingBook = document.createElement('h4');
          removingBook.setAttribute('style',
              'display:grid; align-items:center;justify-content:center;border-right-style:solid;border-right-width:1px');
  ...
  submitbutton.onclick = function () {
      ...
      pages = Number(pageNumberTest.value);
      ...
      if (checkTitle.length == 0 || myLibrary[myLibrary.length - 1].title == '' || checkAUthor.length == 0 || myLibrary[myLibrary.length - 1].author == '' || (checkPages.length == 0 || myLibrary[myLibrary.length - 1].pages < 1)) {
          myLibrary.pop();
